...
from PDFchat.htmlTemplate import css, bot_template, user_template
...
def main():
    ...
    user_question = st.text_input("Ask the question about the document")
    if user_question:
    ...
    with st.sidebar:
        ...
        if st.button("Submit"):
            ...
            #create conversation chain
                ...
                st.success("Conversation chain initialized successfully. You can now ask questions!")
